...
class BaseDataGenerator(data_utils.Sequence):
    ...
    def __init__(self, config, shuffle, use_data_augmentation):
        ...
        self.y_query_size = self.config['image']['query_image_size']['y_size']
        self.x_query_size = self.config['image']['query_image_size']['x_size']
